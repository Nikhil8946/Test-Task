...
<body>
    ...
    <form id="customer-form" action="../controller/mail.php" method="post">
        ...
        <input type="number" name="total-payable-amount" id="total-payable-amount" value="  <?php
                                                                                            include '../controller/caltotal.php';
                                                                                            $obj = new calculate();
                                                                                            echo $obj->totalcal();
                                                                                            ?>" disabled>
